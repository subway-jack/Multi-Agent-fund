...
from src.configs.models.base_config import BaseConfig


class _NotGivenType:
    """Sentinel to mean: field was not provided at all (distinct from None)."""
    __slots__ = ()

    def __repr__(self) -> str:  # debug-friendly
        return "NOT_GIVEN"

    def __bool__(self) -> bool:  # treat as falsy if used in conditionals
        return False
